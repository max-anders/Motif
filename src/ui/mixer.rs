...
impl MixerUi {
        ...
        egui::ScrollArea::horizontal()
            ...
            .show(ui, |ui| {
                ui.horizontal_top(|ui| {
                    ...
                    self.master_strip(ui, project, history, ml, mr, theme);
                });
            });
    }
    ...
    fn channel_strip(
        ...
        strip_container(ui, Id::new(("mixer_strip", track_id)), selected, selected, theme, |ui| {
            ...
            let response =
                fader_section(ui, &mut gain, MIN_GAIN_DB..=MAX_GAIN_DB, peak_l, peak_r, theme);
    ...
    fn master_strip(
        ...
        strip_container(ui, Id::new("mixer_strip_master"), true, false, theme, |ui| {
...
fn painted_value(ui: &mut Ui, size: Vec2, text: &str, color: Color32) {
